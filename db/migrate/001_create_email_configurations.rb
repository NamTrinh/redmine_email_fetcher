...
# Upgrade to Redmine v5.0.5

class CreateEmailConfigurations < Rails.version < '5.1' ? ActiveRecord::Migration : ActiveRecord::Migration[4.2]
  def self.up
    create_table :email_configurations, if_not_exists: true do |t|
	...
	add_index :email_configurations, [:host, :port, :username, :folder], unique: true, name: 'index_unique_email_configuration', if_not_exists: true
